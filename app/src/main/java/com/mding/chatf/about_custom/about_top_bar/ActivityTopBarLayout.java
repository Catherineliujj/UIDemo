package com.mding.chatf.about_custom.about_top_bar;
...
public class ActivityTopBarLayout extends LinearLayout {
    ...
    public ActivityTopBarLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        View inflate = LayoutInflater.from(context).inflate(R.layout.layout_activity_topbar, this);
